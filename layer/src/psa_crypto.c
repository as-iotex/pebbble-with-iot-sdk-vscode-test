...
#include "iotex/psa_crypto_random_impl.h"
...
typedef struct
{
    ...
    iotex_psa_random_context_t rng;
} psa_global_data_t;

static psa_global_data_t global_data;

#if !defined(IOTEX_PSA_CRYPTO_EXTERNAL_RNG)
iotex_psa_drbg_context_t *const iotex_psa_random_state =
...
psa_status_t iotex_to_psa_error( int ret )
{
    /* IOTEX error codes can combine a high-level error code and a
    ...
    switch( low_level_ret != 0 ? low_level_ret : ret )
    {
        ...
        case IOTEX_ERR_AES_INVALID_KEY_LENGTH:
        case IOTEX_ERR_AES_INVALID_INPUT_LENGTH:
            return( PSA_ERROR_NOT_SUPPORTED );
        case IOTEX_ERR_ASN1_OUT_OF_DATA:
        case IOTEX_ERR_ASN1_UNEXPECTED_TAG:
        case IOTEX_ERR_ASN1_INVALID_LENGTH:
        case IOTEX_ERR_ASN1_LENGTH_MISMATCH:
        case IOTEX_ERR_ASN1_INVALID_DATA:
            return( PSA_ERROR_INVALID_ARGUMENT );
        case IOTEX_ERR_ASN1_ALLOC_FAILED:
            return( PSA_ERROR_INSUFFICIENT_MEMORY );
        case IOTEX_ERR_ASN1_BUF_TOO_SMALL:
            return( PSA_ERROR_BUFFER_TOO_SMALL );

#if defined(IOTEX_ERR_CAMELLIA_BAD_INPUT_DATA)
        case IOTEX_ERR_CAMELLIA_BAD_INPUT_DATA:
#endif
        case IOTEX_ERR_CAMELLIA_INVALID_INPUT_LENGTH:
            return( PSA_ERROR_NOT_SUPPORTED );

        case IOTEX_ERR_CCM_BAD_INPUT:
            return( PSA_ERROR_INVALID_ARGUMENT );
        case IOTEX_ERR_CCM_AUTH_FAILED:
            return( PSA_ERROR_INVALID_SIGNATURE );

        case IOTEX_ERR_CHACHA20_BAD_INPUT_DATA:
            return( PSA_ERROR_INVALID_ARGUMENT );

        case IOTEX_ERR_CHACHAPOLY_BAD_STATE:
            return( PSA_ERROR_BAD_STATE );
        case IOTEX_ERR_CHACHAPOLY_AUTH_FAILED:
            return( PSA_ERROR_INVALID_SIGNATURE );

        case IOTEX_ERR_CIPHER_FEATURE_UNAVAILABLE:
            return( PSA_ERROR_NOT_SUPPORTED );
        case IOTEX_ERR_CIPHER_BAD_INPUT_DATA:
            return( PSA_ERROR_INVALID_ARGUMENT );
        case IOTEX_ERR_CIPHER_ALLOC_FAILED:
            return( PSA_ERROR_INSUFFICIENT_MEMORY );
        case IOTEX_ERR_CIPHER_INVALID_PADDING:
            return( PSA_ERROR_INVALID_PADDING );
        case IOTEX_ERR_CIPHER_FULL_BLOCK_EXPECTED:
            return( PSA_ERROR_INVALID_ARGUMENT );
        case IOTEX_ERR_CIPHER_AUTH_FAILED:
            return( PSA_ERROR_INVALID_SIGNATURE );
        case IOTEX_ERR_CIPHER_INVALID_CONTEXT:
            return( PSA_ERROR_CORRUPTION_DETECTED );

#if !( defined(IOTEX_PSA_CRYPTO_EXTERNAL_RNG) ||      \
       defined(IOTEX_PSA_HMAC_DRBG_MD_TYPE) )
        /* Only check CTR_DRBG error codes if underlying iotex_xxx
         * functions are passed a CTR_DRBG instance. */
        case IOTEX_ERR_CTR_DRBG_ENTROPY_SOURCE_FAILED:
            return( PSA_ERROR_INSUFFICIENT_ENTROPY );
        case IOTEX_ERR_CTR_DRBG_REQUEST_TOO_BIG:
        case IOTEX_ERR_CTR_DRBG_INPUT_TOO_BIG:
            return( PSA_ERROR_NOT_SUPPORTED );
        case IOTEX_ERR_CTR_DRBG_FILE_IO_ERROR:
            return( PSA_ERROR_INSUFFICIENT_ENTROPY );
#endif

        case IOTEX_ERR_DES_INVALID_INPUT_LENGTH:
            return( PSA_ERROR_NOT_SUPPORTED );

        case IOTEX_ERR_ENTROPY_NO_SOURCES_DEFINED:
        case IOTEX_ERR_ENTROPY_NO_STRONG_SOURCE:
        case IOTEX_ERR_ENTROPY_SOURCE_FAILED:
            return( PSA_ERROR_INSUFFICIENT_ENTROPY );

        case IOTEX_ERR_GCM_AUTH_FAILED:
            return( PSA_ERROR_INVALID_SIGNATURE );
        case IOTEX_ERR_GCM_BUFFER_TOO_SMALL:
            return( PSA_ERROR_BUFFER_TOO_SMALL );
        case IOTEX_ERR_GCM_BAD_INPUT:
            return( PSA_ERROR_INVALID_ARGUMENT );

#if !defined(IOTEX_PSA_CRYPTO_EXTERNAL_RNG) &&        \
    defined(IOTEX_PSA_HMAC_DRBG_MD_TYPE)
        /* Only check HMAC_DRBG error codes if underlying iotex_xxx
         * functions are passed a HMAC_DRBG instance. */
        case IOTEX_ERR_HMAC_DRBG_ENTROPY_SOURCE_FAILED:
            return( PSA_ERROR_INSUFFICIENT_ENTROPY );
        case IOTEX_ERR_HMAC_DRBG_REQUEST_TOO_BIG:
        case IOTEX_ERR_HMAC_DRBG_INPUT_TOO_BIG:
            return( PSA_ERROR_NOT_SUPPORTED );
        case IOTEX_ERR_HMAC_DRBG_FILE_IO_ERROR:
            return( PSA_ERROR_INSUFFICIENT_ENTROPY );
#endif

        case IOTEX_ERR_MD_FEATURE_UNAVAILABLE:
            return( PSA_ERROR_NOT_SUPPORTED );
        case IOTEX_ERR_MD_BAD_INPUT_DATA:
            return( PSA_ERROR_INVALID_ARGUMENT );
        case IOTEX_ERR_MD_ALLOC_FAILED:
            return( PSA_ERROR_INSUFFICIENT_MEMORY );
        case IOTEX_ERR_MD_FILE_IO_ERROR:
            return( PSA_ERROR_STORAGE_FAILURE );

        case IOTEX_ERR_MPI_FILE_IO_ERROR:
            return( PSA_ERROR_STORAGE_FAILURE );
        case IOTEX_ERR_MPI_BAD_INPUT_DATA:
            return( PSA_ERROR_INVALID_ARGUMENT );
        case IOTEX_ERR_MPI_INVALID_CHARACTER:
            return( PSA_ERROR_INVALID_ARGUMENT );
        case IOTEX_ERR_MPI_BUFFER_TOO_SMALL:
            return( PSA_ERROR_BUFFER_TOO_SMALL );
        case IOTEX_ERR_MPI_NEGATIVE_VALUE:
            return( PSA_ERROR_INVALID_ARGUMENT );
        case IOTEX_ERR_MPI_DIVISION_BY_ZERO:
            return( PSA_ERROR_INVALID_ARGUMENT );
        case IOTEX_ERR_MPI_NOT_ACCEPTABLE:
            return( PSA_ERROR_INVALID_ARGUMENT );
        case IOTEX_ERR_MPI_ALLOC_FAILED:
            return( PSA_ERROR_INSUFFICIENT_MEMORY );

        case IOTEX_ERR_PK_ALLOC_FAILED:
            return( PSA_ERROR_INSUFFICIENT_MEMORY );
        case IOTEX_ERR_PK_TYPE_MISMATCH:
        case IOTEX_ERR_PK_BAD_INPUT_DATA:
            return( PSA_ERROR_INVALID_ARGUMENT );
        case IOTEX_ERR_PK_FILE_IO_ERROR:
            return( PSA_ERROR_STORAGE_FAILURE );
        case IOTEX_ERR_PK_KEY_INVALID_VERSION:
        case IOTEX_ERR_PK_KEY_INVALID_FORMAT:
            return( PSA_ERROR_INVALID_ARGUMENT );
        case IOTEX_ERR_PK_UNKNOWN_PK_ALG:
            return( PSA_ERROR_NOT_SUPPORTED );
        case IOTEX_ERR_PK_PASSWORD_REQUIRED:
        case IOTEX_ERR_PK_PASSWORD_MISMATCH:
            return( PSA_ERROR_NOT_PERMITTED );
        case IOTEX_ERR_PK_INVALID_PUBKEY:
            return( PSA_ERROR_INVALID_ARGUMENT );
        case IOTEX_ERR_PK_INVALID_ALG:
        case IOTEX_ERR_PK_UNKNOWN_NAMED_CURVE:
        case IOTEX_ERR_PK_FEATURE_UNAVAILABLE:
            return( PSA_ERROR_NOT_SUPPORTED );
        case IOTEX_ERR_PK_SIG_LEN_MISMATCH:
            return( PSA_ERROR_INVALID_SIGNATURE );
        case IOTEX_ERR_PK_BUFFER_TOO_SMALL:
            return( PSA_ERROR_BUFFER_TOO_SMALL );

        case IOTEX_ERR_PLATFORM_HW_ACCEL_FAILED:
            return( PSA_ERROR_HARDWARE_FAILURE );
        case IOTEX_ERR_PLATFORM_FEATURE_UNSUPPORTED:
            return( PSA_ERROR_NOT_SUPPORTED );

        case IOTEX_ERR_RSA_BAD_INPUT_DATA:
            return( PSA_ERROR_INVALID_ARGUMENT );
        case IOTEX_ERR_RSA_INVALID_PADDING:
            return( PSA_ERROR_INVALID_PADDING );
        case IOTEX_ERR_RSA_KEY_GEN_FAILED:
            return( PSA_ERROR_HARDWARE_FAILURE );
        case IOTEX_ERR_RSA_KEY_CHECK_FAILED:
            return( PSA_ERROR_INVALID_ARGUMENT );
        case IOTEX_ERR_RSA_PUBLIC_FAILED:
        case IOTEX_ERR_RSA_PRIVATE_FAILED:
            return( PSA_ERROR_CORRUPTION_DETECTED );
        case IOTEX_ERR_RSA_VERIFY_FAILED:
            return( PSA_ERROR_INVALID_SIGNATURE );
        case IOTEX_ERR_RSA_OUTPUT_TOO_LARGE:
            return( PSA_ERROR_BUFFER_TOO_SMALL );
        case IOTEX_ERR_RSA_RNG_FAILED:
            return( PSA_ERROR_INSUFFICIENT_ENTROPY );

        case IOTEX_ERR_ECP_BAD_INPUT_DATA:
        case IOTEX_ERR_ECP_INVALID_KEY:
            return( PSA_ERROR_INVALID_ARGUMENT );
        case IOTEX_ERR_ECP_BUFFER_TOO_SMALL:
            return( PSA_ERROR_BUFFER_TOO_SMALL );
        case IOTEX_ERR_ECP_FEATURE_UNAVAILABLE:
            return( PSA_ERROR_NOT_SUPPORTED );
        case IOTEX_ERR_ECP_SIG_LEN_MISMATCH:
        case IOTEX_ERR_ECP_VERIFY_FAILED:
            return( PSA_ERROR_INVALID_SIGNATURE );
        case IOTEX_ERR_ECP_ALLOC_FAILED:
            return( PSA_ERROR_INSUFFICIENT_MEMORY );
        case IOTEX_ERR_ECP_RANDOM_FAILED:
            return( PSA_ERROR_INSUFFICIENT_ENTROPY );

        case IOTEX_ERR_ERROR_CORRUPTION_DETECTED:
            return( PSA_ERROR_CORRUPTION_DETECTED );
...
iotex_ecp_group_id iotex_ecc_group_of_psa( psa_ecc_family_t curve,
                                               size_t bits,
                                               int bits_is_sloppy )
{
    switch( curve )
    {
        case PSA_ECC_FAMILY_SECP_R1:
            switch( bits )
            {
                ...
                case 192:
                    return( IOTEX_ECP_DP_SECP192R1 );
#endif
#if defined(PSA_WANT_ECC_SECP_R1_224)
                case 224:
                    return( IOTEX_ECP_DP_SECP224R1 );
#endif
#if defined(PSA_WANT_ECC_SECP_R1_256)
                case 256:
                    return( IOTEX_ECP_DP_SECP256R1 );
#endif
#if defined(PSA_WANT_ECC_SECP_R1_384)
                case 384:
                    return( IOTEX_ECP_DP_SECP384R1 );
#endif
#if defined(PSA_WANT_ECC_SECP_R1_521)
                case 521:
                    return( IOTEX_ECP_DP_SECP521R1 );
                case 528:
                    if( bits_is_sloppy )
                        return( IOTEX_ECP_DP_SECP521R1 );
                    break;
        ...
        case PSA_ECC_FAMILY_BRAINPOOL_P_R1:
            switch( bits )
            {
                ...
                case 256:
                    return( IOTEX_ECP_DP_BP256R1 );
#endif
#if defined(PSA_WANT_ECC_BRAINPOOL_P_R1_384)
                case 384:
                    return( IOTEX_ECP_DP_BP384R1 );
#endif
#if defined(PSA_WANT_ECC_BRAINPOOL_P_R1_512)
                case 512:
                    return( IOTEX_ECP_DP_BP512R1 );
#endif
            }
            break;
        ...
        case PSA_ECC_FAMILY_MONTGOMERY:
            switch( bits )
            {
                ...
                case 255:
                    return( IOTEX_ECP_DP_CURVE25519 );
                case 256:
                    if( bits_is_sloppy )
                        return( IOTEX_ECP_DP_CURVE25519 );
                    break;
        ...
        case PSA_ECC_FAMILY_SECP_K1:
            switch( bits )
            {
                ...
                case 192:
                    return( IOTEX_ECP_DP_SECP192K1 );
#endif
#if defined(PSA_WANT_ECC_SECP_K1_224)
                case 224:
                    return( IOTEX_ECP_DP_SECP224K1 );
#endif
#if defined(PSA_WANT_ECC_SECP_K1_256)
                case 256:
                    return( IOTEX_ECP_DP_SECP256K1 );
#endif
            }
            break;
    }
                                          ...
                                          size_t buffer_length )
{
    ...
    slot->key.data = iotex_calloc( 1, buffer_length );
    if( slot->key.data == NULL )
        return( PSA_ERROR_INSUFFICIENT_MEMORY );
    ...
    size_t *key_buffer_length, size_t *bits )
{
    ...
    defined(IOTEX_PSA_BUILTIN_KEY_TYPE_ECC_PUBLIC_KEY)
        ...
        {
            return( iotex_psa_ecp_import_key( attributes,
                                                data, data_length,
    ...
    defined(IOTEX_PSA_BUILTIN_KEY_TYPE_RSA_PUBLIC_KEY)
        ...
        {
            return( iotex_psa_rsa_import_key( attributes,
                                                data, data_length,
                                                key_buffer, key_buffer_size,
                                                key_buffer_length,
                                                bits ) );
...
psa_status_t psa_remove_key_data_from_memory( psa_key_slot_t *slot )
{
    ...
    if( slot->key.data != NULL )
        iotex_platform_zeroize( slot->key.data, slot->key.bytes);

    iotex_free( slot->key.data );
    slot->key.data = NULL;
    slot->key.bytes = 0;
...
psa_status_t psa_destroy_key( psa_key_id_t key )
{
    ...
    if( iotex_svc_key_id_is_null( key ) )
        return( PSA_SUCCESS );
    ...
    psa_key_attributes_t *attributes )
{
    ...
    ret = iotex_rsa_export( rsa, NULL, NULL, NULL, NULL, &mpi );
    if( ret != 0 )
        goto exit;
    if( iotex_mpi_cmp_int( &mpi, 65537 ) == 0 )
    {
    ...
    buflen = iotex_mpi_size( &mpi );
    buffer = iotex_calloc( 1, buflen );
    if( buffer == NULL )
    {
        ret = IOTEX_ERR_MPI_ALLOC_FAILED;
        goto exit;
    }
    ret = iotex_mpi_write_binary( &mpi, buffer, buflen );
    if( ret != 0 )
        goto exit;
                                     ...
                                     psa_key_attributes_t *attributes )
{
    ...
    attributes->core.flags &= ( IOTEX_PSA_KA_MASK_EXTERNAL_ONLY |
                                IOTEX_PSA_KA_MASK_DUAL_USE );
...
{
    if( attributes->core.flags & IOTEX_PSA_KA_FLAG_HAS_SLOT_NUMBER )
    {
...
#if defined(IOTEX_PSA_BUILTIN_KEY_TYPE_RSA_KEY_PAIR) || \
    defined(IOTEX_PSA_BUILTIN_KEY_TYPE_RSA_PUBLIC_KEY)
            return( iotex_psa_rsa_export_public_key( attributes,
                                                       key_buffer,
                                                       key_buffer_size,
                                                       data,
                                                       data_size,
...
#if defined(IOTEX_PSA_BUILTIN_KEY_TYPE_ECC_KEY_PAIR) || \
    defined(IOTEX_PSA_BUILTIN_KEY_TYPE_ECC_PUBLIC_KEY)
            return( iotex_psa_ecp_export_public_key( attributes,
                                                       key_buffer,
                                                       key_buffer_size,
                                                       data,
                                                       data_size,
    ...
    psa_se_drv_table_entry_t **p_drv )
{
    ...
    {
        if( IOTEX_SVC_KEY_ID_GET_KEY_ID( key ) != 0 )
            return( PSA_ERROR_INVALID_ARGUMENT );
    }
    else
    {
    ...
    if( attributes->core.flags & ~ ( IOTEX_PSA_KA_MASK_EXTERNAL_ONLY |
                                     IOTEX_PSA_KA_MASK_DUAL_USE ) )
        return( PSA_ERROR_INVALID_ARGUMENT );
    ...
    psa_se_drv_table_entry_t **p_drv )
{
    ...
    *p_drv = NULL;
    ...
    slot->attr.flags &= ~IOTEX_PSA_KA_MASK_EXTERNAL_ONLY;
    ...
    const psa_key_attributes_t *attributes )
{
    ...
    defined(IOTEX_PSA_BUILTIN_KEY_TYPE_RSA_PUBLIC_KEY)
        ...
        {
            iotex_rsa_context *rsa = NULL;
            iotex_mpi actual, required;
            int ret = IOTEX_ERR_ERROR_CORRUPTION_DETECTED;

            psa_status_t status = iotex_psa_rsa_load_representation(
                                      slot->attr.type,
                                      slot->key.data,
                                      slot->key.bytes,
                                      &rsa );
            ...
            iotex_mpi_init( &actual );
            iotex_mpi_init( &required );
            ret = iotex_rsa_export( rsa,
                                      NULL, NULL, NULL, NULL, &actual );
            iotex_rsa_free( rsa );
            iotex_free( rsa );
            if( ret != 0 )
                goto rsa_exit;
            ret = iotex_mpi_read_binary( &required,
                                           attributes->domain_parameters,
                                           attributes->domain_parameters_size );
            if( ret != 0 )
                goto rsa_exit;
            if( iotex_mpi_cmp_mpi( &actual, &required ) != 0 )
                ret = IOTEX_ERR_RSA_BAD_INPUT_DATA;
        rsa_exit:
            iotex_mpi_free( &actual );
            iotex_mpi_free( &required );
            if( ret != 0)
                return( iotex_to_psa_error( ret ) );
        }
        else
                             ...
                             psa_key_id_t *key )
{
    ...
    *key = IOTEX_SVC_KEY_ID_INIT;
     ...
     * with storage ( IOTEX_PSA_CRYPTO_SE_C ) ),we have to allocate a
...
#if defined(IOTEX_PSA_CRYPTO_SE_C)
psa_status_t iotex_psa_register_se_key(
    const psa_key_attributes_t *attributes )
{
    psa_status_t status;
    psa_key_slot_t *slot = NULL;
    psa_se_drv_table_entry_t *driver = NULL;
    psa_key_id_t key = IOTEX_SVC_KEY_ID_INIT;
                           ...
                           psa_key_id_t *target_key )
{
    ...
    *target_key = IOTEX_SVC_KEY_ID_INIT;
                              ...
                              size_t hash_length )
{
    ...
    if( iotex_psa_safer_memcmp( hash, actual_hash, actual_hash_length ) != 0 )
        status = PSA_ERROR_INVALID_SIGNATURE;
                             ...
                             size_t mac_length)
{
    ...
    if( iotex_psa_safer_memcmp( mac, actual_mac, actual_mac_length ) != 0 )
    {
        status = PSA_ERROR_INVALID_SIGNATURE;
        goto exit;
    }
...
exit:
    iotex_platform_zeroize( actual_mac, sizeof( actual_mac ) );
    ...
    uint8_t *signature, size_t signature_size, size_t *signature_length )
{
    ...
    defined(IOTEX_PSA_BUILTIN_ALG_RSA_PSS)
            return( iotex_psa_rsa_sign_hash(
                        attributes,
                        key_buffer, key_buffer_size,
                        alg, hash, hash_length,
                        signature, signature_size, signature_length ) );
    ...
    defined(IOTEX_PSA_BUILTIN_ALG_DETERMINISTIC_ECDSA)
            return( iotex_psa_ecdsa_sign_hash(
                        attributes,
                        key_buffer, key_buffer_size,
                        alg, hash, hash_length,
                        signature, signature_size, signature_length ) );
...
#if defined(IOTEX_PSA_BUILTIN_ALG_RSA_PKCS1V15_SIGN) || \
    defined(IOTEX_PSA_BUILTIN_ALG_RSA_PSS)
            return( iotex_psa_rsa_verify_hash(
                        attributes,
                        key_buffer, key_buffer_size,
                        alg, hash, hash_length,
                        signature, signature_length ) );
...
#if defined(IOTEX_PSA_BUILTIN_ALG_ECDSA) || \
    defined(IOTEX_PSA_BUILTIN_ALG_DETERMINISTIC_ECDSA)
            return( iotex_psa_ecdsa_verify_hash(
                        attributes,
                        key_buffer, key_buffer_size,
                        alg, hash, hash_length,
                        signature, signature_length ) );
...
static psa_status_t psa_cipher_setup( psa_cipher_operation_t *operation,
                                      psa_key_id_t key,
                                      psa_algorithm_t alg,
                                      iotex_operation_t cipher_operation )
{
    psa_status_t status = PSA_ERROR_CORRUPTION_DETECTED;
    psa_status_t unlock_status = PSA_ERROR_CORRUPTION_DETECTED;
    psa_key_slot_t *slot = NULL;
    psa_key_usage_t usage = ( cipher_operation == IOTEX_ENCRYPT ?
                              PSA_KEY_USAGE_ENCRYPT :
                              PSA_KEY_USAGE_DECRYPT );
    ...
    if( cipher_operation == IOTEX_ENCRYPT )
...
{
    return( psa_cipher_setup( operation, (psa_key_id_t)key, alg, IOTEX_ENCRYPT ) );
}
...
psa_status_t psa_cipher_decrypt_setup( psa_cipher_operation_t *operation,
                                       ...
                                       psa_algorithm_t alg )
{
    return( psa_cipher_setup( operation, (psa_key_id_t)key, alg, IOTEX_DECRYPT ) );
}
...
/****************************************************************/
    ...
    defined(IOTEX_PSA_BUILTIN_ALG_TLS12_PRF) || \
...
psa_status_t psa_key_derivation_abort( psa_key_derivation_operation_t *operation )
{
    ...
    {
        iotex_free( operation->ctx.hkdf.info );
             ...
             PSA_ALG_IS_TLS12_PSK_TO_MS( kdf_alg ) )
    {
        ...
        {
            iotex_platform_zeroize( operation->ctx.tls12_prf.secret,
                                      operation->ctx.tls12_prf.secret_length );
            iotex_free( operation->ctx.tls12_prf.secret );
        }

        if( operation->ctx.tls12_prf.seed != NULL )
        {
            iotex_platform_zeroize( operation->ctx.tls12_prf.seed,
                                      operation->ctx.tls12_prf.seed_length );
            iotex_free( operation->ctx.tls12_prf.seed );
        }

        if( operation->ctx.tls12_prf.label != NULL )
        {
            iotex_platform_zeroize( operation->ctx.tls12_prf.label,
                                      operation->ctx.tls12_prf.label_length );
            iotex_free( operation->ctx.tls12_prf.label );
        }

        if( operation->ctx.tls12_prf.other_secret != NULL )
        {
            iotex_platform_zeroize( operation->ctx.tls12_prf.other_secret,
                                      operation->ctx.tls12_prf.other_secret_length );
            iotex_free( operation->ctx.tls12_prf.other_secret );
        }

        status = PSA_SUCCESS;

        /* We leave the fields Ai and output_block to be erased safely by the
         * iotex_platform_zeroize() in the end of this function. */
    }
    else
#endif /* defined(IOTEX_PSA_BUILTIN_ALG_TLS12_PRF) ||
        * defined(IOTEX_PSA_BUILTIN_ALG_TLS12_PSK_TO_MS) */
    {
        status = PSA_ERROR_BAD_STATE;
    }
    iotex_platform_zeroize( operation, sizeof( *operation ) );
    return( status );
}
...
#if defined(IOTEX_PSA_BUILTIN_KEY_TYPE_DES)
static void psa_des_set_key_parity( uint8_t *data, size_t data_size )
{
    if( data_size >= 8 )
        iotex_des_key_set_parity( data );
    if( data_size >= 16 )
        iotex_des_key_set_parity( data + 8 );
    if( data_size >= 24 )
        iotex_des_key_set_parity( data + 16 );
}
#endif /* IOTEX_PSA_BUILTIN_KEY_TYPE_DES */
    ...
    )
{
    ...
    iotex_mpi_init( &k );
    iotex_mpi_init( &diff_N_2 );

    psa_ecc_family_t curve = PSA_KEY_TYPE_ECC_GET_FAMILY(
                                slot->attr.type );
    iotex_ecp_group_id grp_id =
        iotex_ecc_group_of_psa( curve, bits, 0 );

    if( grp_id == IOTEX_ECP_DP_NONE )
    {
        ret = IOTEX_ERR_ASN1_INVALID_DATA;
        goto cleanup;
    }
    ...
    IOTEX_MPI_CHK( iotex_mpi_sub_int( &diff_N_2, &ecp_group.N, 2 ) );

    /* Note: This function is always called with *data == NULL and it
     * allocates memory for the data buffer. */
    *data = iotex_calloc( 1, m_bytes );
    if( *data == NULL )
    {
        ret = IOTEX_ERR_ASN1_ALLOC_FAILED;
        goto cleanup;
    }
    ...
    while( key_out_of_range )
    {
        ...
        */
        IOTEX_MPI_CHK( iotex_mpi_read_binary( &k, *data, m_bytes ) );

        /* 4. If k > N - 2, discard the result and return to step 1.
        *    Result of comparison is returned. When it indicates error
        *    then this function is called again.
        */
        IOTEX_MPI_CHK( iotex_mpi_lt_mpi_ct( &diff_N_2, &k, &key_out_of_range ) );
    }

    /* 5. Output k + 1 as the private key. */
    IOTEX_MPI_CHK( iotex_mpi_add_int( &k, &k, 1 ) );
    IOTEX_MPI_CHK( iotex_mpi_write_binary( &k, *data, m_bytes ) );
cleanup:
    ...
    )
{
    ...
    *data = iotex_calloc( 1, output_length );
...
#endif /* defined(IOTEX_PSA_BUILTIN_KEY_TYPE_DES) */
    }
    else
        return( PSA_ERROR_NOT_SUPPORTED );
...
static int is_kdf_alg_supported( psa_algorithm_t kdf_alg )
{
    ...
    if( PSA_ALG_IS_HKDF_EXTRACT( kdf_alg ) )
        return( 1 );
#endif
#if defined(IOTEX_PSA_BUILTIN_ALG_HKDF_EXPAND)
                                    ...
                                    size_t data_length )
{
    ...
    switch( step )
    {
        case PSA_KEY_DERIVATION_INPUT_SALT:
            ...
            if( PSA_ALG_IS_HKDF_EXPAND( kdf_alg ) )
                return( PSA_ERROR_INVALID_ARGUMENT );
#endif /* IOTEX_PSA_BUILTIN_ALG_HKDF_EXPAND */
        ...
        case PSA_KEY_DERIVATION_INPUT_INFO:
            ...
            if( data_length != 0 )
            {
                hkdf->info = iotex_calloc( 1, data_length );
                if( hkdf->info == NULL )
                    return( PSA_ERROR_INSUFFICIENT_MEMORY );
                                            ...
                                            size_t data_length )
{
    ...
    if( data_length != 0 )
    {
        prf->seed = iotex_calloc( 1, data_length );
        if( prf->seed == NULL )
            return( PSA_ERROR_INSUFFICIENT_MEMORY );
                                           ...
                                           size_t data_length )
{
    ...
    if( data_length != 0 )
    {
        prf->secret = iotex_calloc( 1, data_length );
        if( prf->secret == NULL )
            return( PSA_ERROR_INSUFFICIENT_MEMORY );
                                             ...
                                             size_t data_length )
{
    ...
    if( data_length != 0 )
    {
        prf->label = iotex_calloc( 1, data_length );
        if( prf->label == NULL )
            return( PSA_ERROR_INSUFFICIENT_MEMORY );
    ...
    size_t data_length )
{
    ...
    uint8_t *pms = iotex_calloc( 1, pms_len );
    if( pms == NULL )
        return( PSA_ERROR_INSUFFICIENT_MEMORY );
    uint8_t *cur = pms;
    ...
    {
        *cur++ = IOTEX_BYTE_1( prf->other_secret_length );
        *cur++ = IOTEX_BYTE_0( prf->other_secret_length );
        if( prf->other_secret_length != 0 )
        {
            memcpy( cur, prf->other_secret, prf->other_secret_length );
            iotex_platform_zeroize( prf->other_secret, prf->other_secret_length );
            cur += prf->other_secret_length;
        }
    }
    else
    {
        *cur++ = IOTEX_BYTE_1( data_length );
        *cur++ = IOTEX_BYTE_0( data_length );
    ...
    *cur++ = IOTEX_BYTE_0( data_length );
    ...
    iotex_platform_zeroize( pms, pms_len );
    iotex_free( pms );
    return( status );
}
    ...
    size_t data_length )
{
    ...
    if( data_length != 0 )
    {
        prf->other_secret = iotex_calloc( 1, data_length );
...
{
    iotex_ecp_keypair *their_key = NULL;
    iotex_ecdh_context ecdh;
    psa_status_t status;
    size_t bits = 0;
    psa_ecc_family_t curve = iotex_ecc_group_to_psa( our_key->grp.id, &bits );
    iotex_ecdh_init( &ecdh );
    ...
    status = iotex_to_psa_error(
        iotex_ecdh_get_params( &ecdh, their_key, IOTEX_ECDH_THEIRS ) );
    if( status != PSA_SUCCESS )
        goto exit;
    status = iotex_to_psa_error(
        iotex_ecdh_get_params( &ecdh, our_key, IOTEX_ECDH_OURS ) );
    if( status != PSA_SUCCESS )
        goto exit;

    status = iotex_to_psa_error(
        iotex_ecdh_calc_secret( &ecdh,
...
exit:
    if( status != PSA_SUCCESS )
        iotex_platform_zeroize( shared_secret, shared_secret_size );
    iotex_ecdh_free( &ecdh );
    iotex_ecp_keypair_free( their_key );
    iotex_free( their_key );
                                                    ...
                                                    size_t *shared_secret_length )
{
    switch( alg )
    {
        ...
        case PSA_ALG_ECDH:
            ...
            psa_status_t status = iotex_psa_ecp_load_representation(
                                                ...
                                                size_t peer_key_length )
{
    ...
    status = psa_key_derivation_input_internal( operation, step,
                                                ...
                                                shared_secret_length );
exit:
    iotex_platform_zeroize( shared_secret, shared_secret_length );
    return( status );
}
 ...
 */
static void iotex_psa_random_init( iotex_psa_random_context_t *rng )
{
#if defined(IOTEX_PSA_CRYPTO_EXTERNAL_RNG)
     ...
     * iotex_psa_crypto_configure_entropy_sources() hasn't been called. */
    if( rng->entropy_init == NULL )
        rng->entropy_init = iotex_entropy_init;
    if( rng->entropy_free == NULL )
        rng->entropy_free = iotex_entropy_free;
    ...
    iotex_entropy_add_source( &rng->entropy,
                                iotex_nv_seed_poll, NULL,
                                IOTEX_ENTROPY_BLOCK_SIZE,
                                IOTEX_ENTROPY_SOURCE_STRONG );
#endif

    iotex_psa_drbg_init( IOTEX_PSA_RANDOM_STATE );
#endif /* IOTEX_PSA_CRYPTO_EXTERNAL_RNG */
}

/** Deinitialize the PSA random generator.
 */
static void iotex_psa_random_free( iotex_psa_random_context_t *rng )
{
#if defined(IOTEX_PSA_CRYPTO_EXTERNAL_RNG)
    memset( rng, 0, sizeof( *rng ) );
#else /* IOTEX_PSA_CRYPTO_EXTERNAL_RNG */
    iotex_psa_drbg_free( IOTEX_PSA_RANDOM_STATE );
 ...
 */
static psa_status_t iotex_psa_random_seed( iotex_psa_random_context_t *rng )
{
#if defined(IOTEX_PSA_CRYPTO_EXTERNAL_RNG)
    ...
    int ret = iotex_psa_drbg_seed( &rng->entropy,
                                  ...
                                  size_t output_size )
{
    ...
    psa_status_t status = iotex_psa_external_get_random( &global_data.rng,
                                                           output, output_size,
                                                           &output_length );
    if( status != PSA_SUCCESS )
        return( status );
    ...
    {
        size_t request_size =
            ( output_size > IOTEX_PSA_RANDOM_MAX_REQUEST ?
              IOTEX_PSA_RANDOM_MAX_REQUEST :
              output_size );
        int ret = iotex_psa_get_random( IOTEX_PSA_RANDOM_STATE,
                                          output, request_size );
        if( ret != 0 )
            return( iotex_to_psa_error( ret ) );
...
//     {
//         return( iotex_psa_rsa_generate_key( attributes,
//                                               key_buffer,
//                                               key_buffer_size,
//                                               key_buffer_length ) );
//     }
...
//     if ( PSA_KEY_TYPE_IS_ECC( type ) && PSA_KEY_TYPE_IS_KEY_PAIR( type ) )
//     {
//         return( iotex_psa_ecp_generate_key( attributes,
//                                               key_buffer,
//                                               key_buffer_size,
//                                               key_buffer_length ) );
//     }
...
psa_status_t psa_crypto_init( void )
{
    ...
    iotex_psa_random_init( &global_data.rng );
    global_data.rng_state = RNG_INITIALIZED;
    status = iotex_psa_random_seed( &global_data.rng );
    if( status != PSA_SUCCESS )
        goto exit;
